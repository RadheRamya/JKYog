...
import threeyrmembership.pageobjects.RegisterThreeYrINRPaymentPage;
...
public class ThreeYearMembershipInr extends ActionEngine {
    public ThreeYearMembershipInr() throws FrameworkException, IOException {
    }
    ...
    public void ThreeYearMembershipInd() throws IOException, FrameworkException {
       ...
       // FreeRegisterPage.clickOnLoginRegisterlink();
        MembershipPlanPage.clickMembershipLink();
        MembershipPlanPage.clickOnPay_inINR_ThreeYrMbr();

        Sheet sheetObj = PojoReader.getExcelReader().getSheetObj("sheetName", "ThreeYrMembershipIND");
        if (sheetObj != null) {
            ...
            if (row1 != null) {
                ...
                for (int i = 0; i < row1.getLastCellNum(); i++) {
                    ...
                    RegisterThreeYrINRPaymentPage.enterFirstName(firstName);
                    RegisterThreeYrINRPaymentPage.enterLastName(lastName);
                    RegisterThreeYrINRPaymentPage.enterUserName(userName);
                    RegisterThreeYrINRPaymentPage.enterEmail(email);
                    RegisterThreeYrINRPaymentPage.enterPassword(password);
                    RegisterThreeYrINRPaymentPage.enterReenterPwd(reenterPwd);
                    RegisterThreeYrINRPaymentPage.enterPhoneInd(phone);
                    RegisterThreeYrINRPaymentPage.enterCity(city);
                    RegisterThreeYrINRPaymentPage.enterState(state);

                    RegisterThreeYrINRPaymentPage.validateCountryInd_ThreeYrINR();
                    RegisterThreeYrINRPaymentPage.clickOnTermsAndConditions();
                    RegisterThreeYrINRPaymentPage.clickOnRegisterButton();
