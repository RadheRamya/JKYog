...
public class RegisterOneYrINRPaymentPage extends BaseTest {

    static {
        PageFactory.initElements(getDriver(), RegisterOneYrINRPaymentPage.class);
    }

    private static final JavascriptExecutor js = (JavascriptExecutor) getDriver();

    @FindBy(xpath = "//input[@id='ff_3_names_first_name_']")
    private static WebElement firstName;

    @FindBy(id = "ff_3_names_last_name_")
    private static WebElement lastName;

    @FindBy(id = "ff_3_input_text")
    private static WebElement userName;

    @FindBy(id = "ff_3_email")
    private static WebElement email;

    @FindBy(id = "ff_3_password")
    private static WebElement password;

    @FindBy(id = "ff_3_password_2")
    private static WebElement reenter_pwd;

    @FindBy(id = "ff_3_phone")
    private static WebElement phone;

    @FindBy(id = "ff_3_city")
    private static WebElement city;

    @FindBy(id = "ff_3_state")
    private static WebElement state;

    @FindBy(id = "ff_3_country-list")
    ...
    public static void validateCountryInd_OneYrINR() {
        boolean status = true;
        try {
            // Check if the default selected country is "India"
            Select countryDropdown = new Select(getDriver().findElement(By.xpath("//select[@id='ff_3_country-list']")));
